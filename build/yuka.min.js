...
function(a,b){b=void 0===b?0:b;var d=this.elements;a[b+0]=d[0];a[b+1]=d[1];a[b+2]=d[2];a[b+3]=d[3];a[b+4]=d[4];a[b+5]=d[5];a[b+6]=d[6];a[b+7]=d[7];a[b+8]=d[8];a[b+9]=d[9];a[b+10]=d[10];a[b+11]=d[11];a[b+12]=d[12];a[b+13]=d[13];a[b+14]=d[14];a[b+15]=d[15];return a};u.prototype.equals=function(a){var b=this.elements;a=a.elements;for(var d=0;16>d;d++)if(b[d]!==a[d])return!1;return!0};var Hb=0,fb=new t,ra=new f,D=function(){this.id=Hb++;this.name="";this.active=!0;this.cache={position:new f,rotation:new t,
scale:new f};this.position=new f;this.rotation=new t;this.scale=new f(1,1,1);this.forward=new f(0,0,1);this.up=new f(0,1,0);this.boundingRadius=0;this.maxTurnRate=Math.PI;this.matrix=new u;this.manager=null};D.prototype.start=function(){};D.prototype.update=function(){};D.prototype.getDirection=function(a){return a.copy(this.forward).applyRotation(this.rotation).normalize()};D.prototype.lookAt=function(a){ra.subVectors(a,this.position).normalize();this.rotation.lookAt(this.forward,ra,this.up);return this};
...
D.prototype.sendMessage=function(a,b,d,c){null!==this.manager?this.manager.sendMessage(this,a,b,void 0===d?0:d,void 0===c?null:c):v.error("YUKA.GameEntity: The game entity must be added to a manager in order to send a message.")};var gb=new f,Fa=new f,T=function(){var a=D.call(this)||this;a.velocity=new f;a.maxSpeed=1;a.updateOrientation=!0;return a};$jscomp.inherits(T,D);T.prototype.update=function(a){this.getSpeedSquared()>this.maxSpeed*this.maxSpeed&&(this.velocity.normalize(),this.velocity.multiplyScalar(this.maxSpeed));
...
for(var d=b.next();!d.done;d=b.next()){d=this._edges.get(d.value.to);for(var c=$jscomp.makeIterator(d),m=c.next();!m.done;m=c.next())if(m=m.value,m.to===a.index){d.delete(m);break}}}else for(b=$jscomp.makeIterator(this._edges.values()),d=b.next();!d.done;d=b.next())for(c=d.value,m=$jscomp.makeIterator(c),d=m.next();!d.done;d=m.next())d=d.value,this.hasNode(d.to)&&this.hasNode(d.from)||c.delete(d);this._edges.delete(a.index);return this};A.prototype.removeEdge=function(a){var b=this._edges.get(a.from);
...
null};O.prototype._up=function(a){for(var b=this.data,d=this.compare,c=b[a];0<a;){var m=a-1>>1,e=b[m];if(0<=d(c,e))break;b[a]=e;a=m}b[a]=c};O.prototype._down=function(a){for(var b=this.data,d=this.compare,c=b[a],m=this.length>>1;a<m;){var e=(a<<1)+1,f=e+1,g=b[e];f<this.length&&0>d(b[f],g)&&(e=f,g=b[f]);if(0<=d(g,c))break;b[a]=g;a=e}b[a]=c};var aa=function(a){this.vertex=a=void 0===a?new f:a;this.polygon=this.twin=this.prev=this.next=null;this.nodeIndex=-1};aa.prototype.from=function(){return this.vertex};
...
new Set};B.prototype.fromPolygons=function(a){this.clear();var b=[],d=[];a=$jscomp.makeIterator(a);for(var c=a.next();!c.done;c=a.next()){c=c.value;var m=c.edge;do b.push(m),m=m.next;while(m!==c.edge);this.regions.add(c)}a=$jscomp.makeIterator(b);for(c=a.next();!c.done;c=a.next())if(c=c.value,null===c.twin){m=$jscomp.makeIterator(b);for(var e=m.next();!e.done;e=m.next())if(e=e.value,c.from().equals(e.to())&&c.to().equals(e.from())){c.twin=e;e.twin=c;m=c.squaredLength();d.push({cost:m,edge:c});break}}d.sort(p);
this._buildRegions(d);this._buildNodeIndices();this._buildGraph();return this};B.prototype.clear=function(){this.graph.clear();this.regions.clear();return this};B.prototype.getClosestNodeIndex=function(a){var b=null,d=Infinity,c=[];this.graph.getNodes(c);c=$jscomp.makeIterator(c);for(var m=c.next();!m.done;m=c.next()){m=m.value;var e=a.squaredDistanceTo(m.position);e<d&&(d=e,b=m.index)}return b};B.prototype.getClosestNodeIndexInRegion=function(a,b,d){var c=null,e=Infinity,f=b.edge;do{if(f.twin||f.prev.twin){var g=
a.squaredDistanceTo(f.from());d&&(g+=d.squaredDistanceTo(f.from()));g<e&&(e=g,c=f.twin?f.nodeIndex:f.prev.twin.nodeIndex)}f=f.next}while(f!==b.edge);return c};B.prototype.getClosestRegion=function(a){for(var b=null,d=Infinity,c=$jscomp.makeIterator(this.regions),e=c.next();!e.done;e=c.next()){e=e.value;var f=a.squaredDistanceTo(e.centroid);f<d&&(d=f,b=e)}return b};B.prototype.getRegionForPoint=function(a,b){b=void 0===b?.001:b;for(var d=$jscomp.makeIterator(this.regions),c=d.next();!c.done;c=d.next())if(c=
c.value,!0===c.contains(a,b))return c;return null};B.prototype.findPath=function(a,b){var d=this.graph,c=this.getRegionForPoint(a),e=this.getRegionForPoint(b),g=[];if(null===c||null===e)null===c&&(c=this.getClosestRegion(a)),null===e&&(e=this.getClosestRegion(b));if(c===e)g.push((new f).copy(a)),g.push((new f).copy(b));else{var h=this.getClosestNodeIndexInRegion(a,c,b),k=this.getClosestNodeIndexInRegion(b,e,a);h=new ba(d,h,k);h.search();if(!0===h.found){h=h.getPath();k=h.length;for(var l=0,p=h.length;l<
p;l++){var r=d.getNode(h[l]);if(!1===c.contains(r.position)){k=l;break}}h.splice(0,k-1);h.reverse();k=h.length;c=0;for(p=h.length;c<p;c++)if(l=d.getNode(h[c]),!1===e.contains(l.position)){k=c;break}h.splice(0,k-1);h.reverse();g.push((new f).copy(a));a=$jscomp.makeIterator(h);for(e=a.next();!e.done;e=a.next())e=d.getNode(e.value),g.push((new f).copy(e.position));g.push((new f).copy(b))}}return g};B.prototype.clampMovement=function(a,b,d,c){var e=this.getRegionForPoint(d);if(null===e){if(null===a)throw Error("YUKA.NavMesh.clampMovement(): No current region available.");
e=null;var n=Infinity,f=a.edge;do{if(null===f.twin){ha.set(f.vertex,f.next.vertex);var g=ha.closestPointToPointParameter(b);ha.at(g,Ia);g=Ia.squaredDistanceTo(b);g<n&&(n=g,e=f,nb.copy(Ia))}f=f.next}while(f!==a.edge);Ja.subVectors(e.next.vertex,e.vertex).normalize();d=Ka.subVectors(d,b).length();Ka.divideScalar(d);n=Ja.dot(Ka);fa.copy(nb).add(Ja.multiplyScalar(n*d));ha.set(e.vertex,e.next.vertex);e=ha.closestPointToPointParameter(fa,!1);if(0<=e&&1>=e)c.copy(fa);else{e=this.getRegionForPoint(fa);if(null!==
e)return c.copy(fa),e;c.copy(b)}return a}return e};B.prototype._buildRegions=function(a){var b=this.regions;a=$jscomp.makeIterator(a);for(var d=a.next();!d.done;d=a.next()){d=d.value;var c=d.edge;var e=c.prev;var f=c.next;var g=c.twin.prev;var h=c.twin.next;c.prev.next=c.twin.next;c.next.prev=c.twin.prev;c.twin.prev.next=c.next;c.twin.next.prev=c.prev;var k=c.polygon;k.edge=c.prev;if(!0===k.convex()){e=k.edge;do e.polygon=k,e=e.next;while(e!==k.edge);b.delete(d.edge.twin.polygon)}else e.next=c,f.prev=
c,g.next=c.twin,h.prev=c.twin,k.edge=c}b=$jscomp.makeIterator(b);for(a=b.next();!a.done;a=b.next())a.value.computeCentroid()};B.prototype._buildNodeIndices=function(){var a=this.regions,b=new Map,d=0;a=$jscomp.makeIterator(a);for(var c=a.next();!c.done;c=a.next()){c=c.value;var e=c.edge;do{if(null!==e.twin){for(var f=-1,g=e.from(),h=$jscomp.makeIterator(b.entries()),k=h.next();!k.done;k=h.next()){var l=$jscomp.makeIterator(k.value);k=l.next().value;l=l.next().value;if(!0===g.equals(l)){f=k;break}}-1===
...
$jscomp.makeIterator(b),e=c.next();!e.done;e=c.next()){e=e.value;f=$jscomp.makeIterator(b);for(var g=f.next();!g.done;g=f.next())if(g=g.value,e!==g&&!1===a.hasEdge(e,g)){var h=a.getNode(e),k=a.getNode(g);h=h.position.distanceTo(k.position);a.addEdge(new ta(e,g,h))}}return this};var V=function(){this.centroid=new f;this.edge=null};V.prototype.fromContour=function(a){var b=[];if(3>a.length)return v.error("YUKA.Polygon: Unable to create polygon from contour. It needs at least three points."),this;for(var d=
...
this.loadBuffer(b);break;case "bufferView":f=this.loadBufferView(b);break;case "mesh":f=this.loadMesh(b);break;default:throw Error("Unknown type: "+a);}c.set(e,f)}return f};I.prototype.loadBuffer=function(a){var b=this,c=this.json.buffers[a];return void 0===c.uri&&0===a?Promise.resolve(this.extensions.get("BINARY").body):new Promise(function(a,d){var e=g(c.uri,b.path);fetch(e).then(function(a){return a.arrayBuffer()}).then(function(b){a(b)}).catch(function(a){v.error("YUKA.NavMeshLoader: Unable to load buffer.",
a);d(a)})})};I.prototype.loadBufferView=function(a){var b=this.json.bufferViews[a];return this.getDependency("buffer",b.buffer).then(function(a){var c=b.byteOffset||0;return a.slice(c,c+(b.byteLength||0))})};I.prototype.loadAccessor=function(a){var b=this.json.accessors[a];return this.getDependency("bufferView",b.bufferView).then(function(a){return new Ib[b.componentType](a,b.byteOffset||0,b.count*Jb[b.type])})};I.prototype.loadMesh=function(a){var b=this.json.meshes[a];return this.getDependencies("accessor").then(function(a){var c=
b.primitives[0];if(4!==c.mode)throw Error("YUKA.NavMeshLoader: Invalid geometry format. Please ensure to represent your geometry as triangles.");return{index:a[c.indices],position:a[c.attributes.POSITION],normal:a[c.attributes.NORMAL]}})};I.prototype.parseBinary=function(a){for(var b=new DataView(a,12),c=0,e=new TextDecoder,f=null,g=null;c<b.byteLength;){var h=b.getUint32(c,!0);c+=4;var k=b.getUint32(c,!0);c+=4;k===pb.JSON?(f=new Uint8Array(a,12+c,h),f=e.decode(f)):k===pb.BIN&&(g=12+c,g=a.slice(g,
g+h));c+=h}this.extensions.set("BINARY",{content:f,body:g})};var Jb={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},Ib={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},pb={JSON:1313821514,BIN:5130562},ia=function(a,b,c){this.graph=void 0===a?null:a;this.source=void 0===b?-1:b;this.target=void 0===c?-1:c;this.found=!1;this._route=new Map;this._visited=new Set;this._spanningTree=new Set};ia.prototype.search=function(){var a=[],b=[],c=new U(this.source,
this.source);for(a.push(c);0<a.length;){var e=a.pop();this._route.set(e.to,e.from);this._visited.add(e.to);e!==c&&this._spanningTree.add(e);if(e.to===this.target)return this.found=!0,this;this.graph.getEdgesOfNode(e.to,b);e=$jscomp.makeIterator(b);for(var f=e.next();!f.done;f=e.next())f=f.value,!1===this._visited.has(f.to)&&a.push(f)}this.found=!1;return this};ia.prototype.getPath=function(){var a=[];if(!1===this.found||-1===this.target)return a;var b=this.target;for(a.push(b);b!==this.source;)b=
this._route.get(b),a.unshift(b);return a};ia.prototype.getSearchTree=function(){return[].concat($jscomp.arrayFromIterable(this._spanningTree))};ia.prototype.clear=function(){this.found=!1;this._route.clear();this._visited.clear();this._spanningTree.clear()};var ja=function(a,b,c){this.graph=void 0===a?null:a;this.source=void 0===b?-1:b;this.target=void 0===c?-1:c;this.found=!1;this._route=new Map;this._visited=new Set;this._spanningTree=new Set};ja.prototype.search=function(){var a=[],b=[],c=new U(this.source,
this.source);a.push(c);for(this._visited.add(this.source);0<a.length;){var e=a.shift();this._route.set(e.to,e.from);e!==c&&this._spanningTree.add(e);if(e.to===this.target)return this.found=!0,this;this.graph.getEdgesOfNode(e.to,b);e=$jscomp.makeIterator(b);for(var f=e.next();!f.done;f=e.next())f=f.value,!1===this._visited.has(f.to)&&(a.push(f),this._visited.add(f.to))}this.found=!1;return this};ja.prototype.getPath=function(){var a=[];if(!1===this.found||-1===this.target)return a;var b=this.target;
...
a.direction.equals(this.direction)};var zb=new u,da=new f,Sa=new f,Ta=new f,Ab=new E,Kb=new P(new f(0,0,0),new f(0,0,1)),Ua=function(a){a=void 0===a?null:a;var b=y.call(this)||this;b.entityManager=a;b.weigth=3;b.dBoxMinLength=5;b._waypoint=null;b._seek=new ca;return b};$jscomp.inherits(Ua,y);Ua.prototype.calculate=function(a,b){var c=null,e=Infinity,f=this.entityManager.entities.values(),g=this.dBoxMinLength+a.getSpeed()/a.maxSpeed*this.dBoxMinLength;zb.getInverse(a.matrix);f=$jscomp.makeIterator(f);
for(var h=f.next();!h.done;h=f.next())if(h=h.value,h!==a&&(da.copy(h.position).applyMatrix4(zb),0<da.z&&Math.abs(da.z)<g)){var k=h.boundingRadius+a.boundingRadius;Math.abs(da.x)<k&&(Ab.set(da,k),Kb.intersectSphere(Ab,Ta),Ta.z<e&&(e=Ta.z,c=h,Sa.copy(da)))}null!==c&&(this._waypoint=Sa.clone(),this._waypoint.x-=(c.boundingRadius+a.boundingRadius)*Math.sign(Sa.x),this._waypoint.applyMatrix4(a.matrix));null!==this._waypoint&&(1>this._waypoint.squaredDistanceTo(a.position)?this._waypoint=null:(this._seek.target=
this._waypoint,this._seek.calculate(a,b)))};var Va=new f,Wa=new f,Bb=new f,Cb=new f,Db=new f,Xa=function(a,b){a=void 0===a?null:a;b=void 0===b?1:b;var c=y.call(this)||this;c.evader=a;c.predictionFactor=b;c._seek=new ca;return c};$jscomp.inherits(Xa,y);Xa.prototype.calculate=function(a,b){var c=this.evader;Va.subVectors(c.position,a.position);a.getDirection(Wa);c.getDirection(Bb);var e=0<Va.dot(Wa),f=-.95>Wa.dot(Bb);!0===e&&!0===f?this._seek.target=c.position:(e=Va.length()/(a.maxSpeed+c.getSpeed()),
e*=this.predictionFactor,Cb.copy(c.velocity).multiplyScalar(e),Db.addVectors(c.position,Cb),this._seek.target=Db);this._seek.calculate(a,b)};var na=new f,Ya=new f,Aa=function(a,b,c){a=void 0===a?1:a;b=void 0===b?5:b;c=void 0===c?5:c;var d=y.call(this)||this;d.radius=a;d.distance=b;d.jitter=c;d._targetLocal=new f;d._setup();return d};$jscomp.inherits(Aa,y);Aa.prototype.calculate=function(a,b,c){c*=this.jitter;Ya.x=Y.randFloat(-1,1)*c;Ya.z=Y.randFloat(-1,1)*c;this._targetLocal.add(Ya);this._targetLocal.normalize();
...
this.currentState.execute(this.owner)};K.prototype.add=function(a,b){b instanceof ea?this.states.set(a,b):v.warn('YUKA.StateMachine: .add() needs a parameter of type "YUKA.State".')};K.prototype.remove=function(a){this.states.delete(a)};K.prototype.get=function(a){return this.states.get(a)};K.prototype.changeTo=function(a){a=this.get(a);this._change(a)};K.prototype.revert=function(){this._change(this.previousState)};K.prototype.in=function(a){return this.get(a)===this.currentState};K.prototype.handleMessage=
function(a){return null!==this.currentState&&!0===this.currentState.onMessage(this.owner,a)||null!==this.globalState&&!0===this.globalState.onMessage(this.owner,a)?!0:!1};K.prototype._change=function(a){this.previousState=this.currentState;this.currentState.exit(this.owner);this.currentState=a;this.currentState.enter(this.owner)};var r=function(a){this.owner=void 0===a?null:a;this.status=r.STATUS.INACTIVE};r.prototype.addSubgoal=function(){v.warn("YUKA.Goal: Unable to add goal to atomic goals.")};
r.prototype.activate=function(){};r.prototype.execute=function(){};r.prototype.terminate=function(){};r.prototype.handleMessage=function(){return!1};r.prototype.active=function(){return this.status===r.STATUS.ACTIVE};r.prototype.inactive=function(){return this.status===r.STATUS.INACTIVE};r.prototype.completed=function(){return this.status===r.STATUS.COMPLETED};r.prototype.failed=function(){return this.status===r.STATUS.FAILED};r.prototype.replanIfFailed=function(){!0===this.failed()&&(this.status=
r.STATUS.INACTIVE);return this};r.prototype.activateIfInactive=function(){!0===this.inactive()&&(this.activate(),this.status=r.STATUS.ACTIVE);return this};r.STATUS=Object.freeze({ACTIVE:"active",INACTIVE:"inactive",COMPLETED:"completed",FAILED:"failed"});var M=function(a){a=r.call(this,void 0===a?null:a)||this;a.subgoals=[];return a};$jscomp.inherits(M,r);M.prototype.addSubgoal=function(a){this.subgoals.push(a);return this};M.prototype.clearSubgoals=function(){for(var a=this.subgoals,b=$jscomp.makeIterator(a),
c=b.next();!c.done;c=b.next())c.value.terminate();a.length=0;return this};M.prototype.currentSubgoal=function(){var a=this.subgoals.length;return 0<a?this.subgoals[a-1]:null};M.prototype.executeSubgoals=function(){for(var a=this.subgoals,b=a.length-1;0<=b;b--){var c=a[b];if(!0===c.completed()||!0===c.failed())c.terminate(),a.pop();else break}b=this.currentSubgoal();return null!==b?(b.activateIfInactive(),b.execute(),!0===b.completed()&&1<a.length?r.STATUS.ACTIVE:b.status):r.STATUS.COMPLETED};M.prototype.hasSubgoals=
