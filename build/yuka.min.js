...
!0:b;mb.subVectors(a,this.from);ua.subVectors(this.to,this.from);a=ua.dot(ua);a=ua.dot(mb)/a;b&&(a=Y.clamp(a,0,1));return a};H.prototype.equals=function(a){return a.from.equals(this.from)&&a.to.equals(this.to)};var Ia=new f,nb=new f,Ja=new f,Ka=new f,fa=new f,ha=new H,B=function(){this.graph=new A;this.graph.digraph=!0;this.regions=new Set};B.prototype.fromPolygons=function(a){this.clear();var b=[],d=[];a=$jscomp.makeIterator(a);for(var c=a.next();!c.done;c=a.next()){c=c.value;var m=c.edge;do b.push(m),
m=m.next;while(m!==c.edge);this.regions.add(c)}a=$jscomp.makeIterator(b);for(c=a.next();!c.done;c=a.next())if(c=c.value,null===c.twin){m=$jscomp.makeIterator(b);for(var e=m.next();!e.done;e=m.next())if(e=e.value,c.from().equals(e.to())&&c.to().equals(e.from())){c.twin=e;e.twin=c;m=c.squaredLength();d.push({cost:m,edge:c});break}}d.sort(p);this._buildRegions(d);this._buildNodeIndices();this._buildGraph();return this};B.prototype.clear=function(){this.graph.clear();this.regions.clear();return this};
B.prototype.getClosestNodeIndex=function(a){var b=null,d=Infinity,c=[];this.graph.getNodes(c);c=$jscomp.makeIterator(c);for(var m=c.next();!m.done;m=c.next()){m=m.value;var e=a.squaredDistanceTo(m.position);e<d&&(d=e,b=m.index)}return b};B.prototype.getClosestNodeIndexInRegion=function(a,b,d){var c=null,e=Infinity,f=b.edge;do{if(f.twin||f.prev.twin){var g=a.squaredDistanceTo(f.from());d&&(g+=d.squaredDistanceTo(f.from()));g<e&&(e=g,c=f.twin?f.nodeIndex:f.prev.twin.nodeIndex)}f=f.next}while(f!==b.edge);
return c};B.prototype.getClosestRegion=function(a){for(var b=null,d=Infinity,c=$jscomp.makeIterator(this.regions),e=c.next();!e.done;e=c.next()){e=e.value;var f=a.squaredDistanceTo(e.centroid);f<d&&(d=f,b=e)}return b};B.prototype.getRegionForPoint=function(a,b){b=void 0===b?.001:b;for(var d=$jscomp.makeIterator(this.regions),c=d.next();!c.done;c=d.next())if(c=c.value,!0===c.contains(a,b))return c;return null};B.prototype.findPath=function(a,b){var d=this.graph,c=this.getRegionForPoint(a),e=this.getRegionForPoint(b),
g=[];if(null===c||null===e)null===c&&(c=this.getClosestRegion(a)),null===e&&(e=this.getClosestRegion(b));if(c===e)g.push((new f).copy(a)),g.push((new f).copy(b));else{var h=this.getClosestNodeIndexInRegion(a,c,b),k=this.getClosestNodeIndexInRegion(b,e,a);h=new ba(d,h,k);h.search();if(!0===h.found){h=h.getPath();k=h.length;for(var l=0,p=h.length;l<p;l++){var r=d.getNode(h[l]);if(!1===c.contains(r.position)){k=l;break}}h.splice(0,k-1);h.reverse();k=h.length;c=0;for(p=h.length;c<p;c++)if(l=d.getNode(h[c]),
!1===e.contains(l.position)){k=c;break}h.splice(0,k-1);h.reverse();g.push((new f).copy(a));a=$jscomp.makeIterator(h);for(e=a.next();!e.done;e=a.next())e=d.getNode(e.value),g.push((new f).copy(e.position));g.push((new f).copy(b))}}return g};B.prototype.clampMovement=function(a,b,d,c){var e=this.getRegionForPoint(d);if(null===e){if(null===a)throw Error("YUKA.NavMesh.clampMovement(): No current region available.");e=null;var n=Infinity,f=a.edge;do{if(null===f.twin){ha.set(f.vertex,f.next.vertex);var g=
ha.closestPointToPointParameter(b);ha.at(g,Ia);g=Ia.squaredDistanceTo(b);g<n&&(n=g,e=f,nb.copy(Ia))}f=f.next}while(f!==a.edge);Ja.subVectors(e.next.vertex,e.vertex).normalize();d=Ka.subVectors(d,b).length();Ka.divideScalar(d);n=Ja.dot(Ka);fa.copy(nb).add(Ja.multiplyScalar(n*d));ha.set(e.vertex,e.next.vertex);e=ha.closestPointToPointParameter(fa,!1);if(0<=e&&1>=e)c.copy(fa);else{e=this.getRegionForPoint(fa);if(null!==e)return c.copy(fa),e;c.copy(b)}return a}return e};B.prototype._buildRegions=function(a){var b=
this.regions;a=$jscomp.makeIterator(a);for(var d=a.next();!d.done;d=a.next()){d=d.value;var c=d.edge;var e=c.prev;var f=c.next;var g=c.twin.prev;var h=c.twin.next;c.prev.next=c.twin.next;c.next.prev=c.twin.prev;c.twin.prev.next=c.next;c.twin.next.prev=c.prev;var k=c.polygon;k.edge=c.prev;if(!0===k.convex()){e=k.edge;do e.polygon=k,e=e.next;while(e!==k.edge);b.delete(d.edge.twin.polygon)}else e.next=c,f.prev=c,g.next=c.twin,h.prev=c.twin,k.edge=c}b=$jscomp.makeIterator(b);for(a=b.next();!a.done;a=
b.next())a.value.computeCentroid()};B.prototype._buildNodeIndices=function(){var a=this.regions,b=new Map,d=0;a=$jscomp.makeIterator(a);for(var c=a.next();!c.done;c=a.next()){c=c.value;var e=c.edge;do{if(null!==e.twin){for(var f=-1,g=e.from(),h=$jscomp.makeIterator(b.entries()),k=h.next();!k.done;k=h.next()){var l=$jscomp.makeIterator(k.value);k=l.next().value;l=l.next().value;if(!0===g.equals(l)){f=k;break}}-1===f&&(f=d++,b.set(f,g));e.nodeIndex=f;e.twin.next.nodeIndex=f}e=e.next}while(e!==c.edge)}};
B.prototype._buildGraph=function(){var a=this.graph,b=this.regions,d=new Set;b=$jscomp.makeIterator(b);for(var c=b.next();!c.done;c=b.next()){c=c.value;var e=[];d.add(e);var f=c.edge;do null!==f.twin&&(e.push(f.nodeIndex,f.twin.nodeIndex),!1===a.hasNode(f.nodeIndex)&&a.addNode(new sa(f.nodeIndex,f.from()))),f=f.next;while(f!==c.edge)}d=$jscomp.makeIterator(d);for(b=d.next();!b.done;b=d.next())for(b=b.value,c=$jscomp.makeIterator(b),e=c.next();!e.done;e=c.next()){e=e.value;f=$jscomp.makeIterator(b);
for(var g=f.next();!g.done;g=f.next())if(g=g.value,e!==g&&!1===a.hasEdge(e,g)){var h=a.getNode(e),k=a.getNode(g);h=h.position.distanceTo(k.position);a.addEdge(new ta(e,g,h))}}return this};var V=function(){this.centroid=new f;this.edge=null};V.prototype.fromContour=function(a){var b=[];if(3>a.length)return v.error("YUKA.Polygon: Unable to create polygon from contour. It needs at least three points."),this;for(var d=0,c=a.length;d<c;d++){var e=new aa(a[d]);b.push(e)}a=0;for(c=b.length;a<c;a++){if(0===
a){d=b[a];e=b[c-1];var f=b[a+1]}else a===c-1?(d=b[a],e=b[a-1],f=b[0]):(d=b[a],e=b[a-1],f=b[a+1]);d.prev=e;d.next=f;d.polygon=this}this.edge=b[0];return this};V.prototype.computeCentroid=function(){var a=this.centroid,b=this.edge,d=0;a.set(0,0,0);do a.add(b.from()),d++,b=b.next;while(b!==this.edge);a.divideScalar(d);return this};V.prototype.contains=function(a,b){b=void 0===b?.001:b;var d=this.edge,c=-Infinity,e=Infinity;do{var f=d.from(),g=d.to();if(!1===0<=(a.x-f.x)*(g.z-f.z)-(g.x-f.x)*(a.z-f.z))return!1;
f.y>c&&(c=f.y);f.y<e&&(e=f.y);d=d.next}while(d!==this.edge);return a.y<=c+b&&a.y>=e-b};V.prototype.convex=function(){var a=this.edge;do{var b=a.from(),d=a.to(),c=a.next.to();if(!1===0<=(c.x-b.x)*(d.z-b.z)-(d.x-b.x)*(c.z-b.z))return!1;a=a.next}while(a!==this.edge);return!0};var ob=function(){};ob.prototype.load=function(a){return new Promise(function(b,d){fetch(a).then(function(a){if(200<=a.status&&300>a.status)return a.arrayBuffer();var b=Error(a.statusText||a.status);b.response=a;return Promise.reject(b)}).then(function(b){var d=
new I,c=new TextDecoder;"glTF"===c.decode(new Uint8Array(b,0,4))?(d.parseBinary(b),b=d.extensions.get("BINARY").content):b=c.decode(new Uint8Array(b));b=JSON.parse(b);if(void 0===b.asset||2>b.asset.version[0])throw Error("YUKA.NavMeshLoader: Unsupported asset version.");c=a.lastIndexOf("/");c=-1===c?"./":a.substr(0,c+1);return d.parse(b,c)}).then(function(a){b(a)}).catch(function(a){v.error("YUKA.NavMeshLoader: Unable to load navigation mesh.",a);d(a)})})};var I=function(){this.path=this.json=null;
this.cache=new Map;this.extensions=new Map};I.prototype.parse=function(a,b){var d=this;this.json=a;this.path=b;return this.getDependency("mesh",0).then(function(a){a=d.parseGeometry(a);return(new B).fromPolygons(a)})};I.prototype.parseGeometry=function(a){var b=a.index,d=a.position;a=[];for(var c=[],e=0,g=d.length;e<g;e+=3){var h=new f;h.x=d[e+0];h.y=d[e+1];h.z=d[e+2];a.push(h)}if(b)for(d=0,g=b.length;d<g;d+=3)e=[a[b[d+0]],a[b[d+1]],a[b[d+2]]],e=(new V).fromContour(e),c.push(e);else for(b=0,g=a.length;b<
g;b+=3)d=[a[b+0],a[b+1],a[b+2]],d=(new V).fromContour(d),c.push(d);return c};I.prototype.getDependencies=function(a){var b=this,c=this.cache,e=c.get(a);e||(e=Promise.all((this.json[a+("mesh"===a?"es":"s")]||[]).map(function(c,d){return b.getDependency(a,d)})),c.set(a,e));return e};I.prototype.getDependency=function(a,b){var c=this.cache,e=a+":"+b,f=c.get(e);if(void 0===f){switch(a){case "accessor":f=this.loadAccessor(b);break;case "buffer":f=this.loadBuffer(b);break;case "bufferView":f=this.loadBufferView(b);
...
c.mode)throw Error("YUKA.NavMeshLoader: Invalid geometry format. Please ensure to represent your geometry as triangles.");return{index:a[c.indices],position:a[c.attributes.POSITION],normal:a[c.attributes.NORMAL]}})};I.prototype.parseBinary=function(a){for(var b=new DataView(a,12),c=0,e=new TextDecoder,f=null,g=null;c<b.byteLength;){var h=b.getUint32(c,!0);c+=4;var k=b.getUint32(c,!0);c+=4;k===pb.JSON?(f=new Uint8Array(a,12+c,h),f=e.decode(f)):k===pb.BIN&&(g=12+c,g=a.slice(g,g+h));c+=h}this.extensions.set("BINARY",
{content:f,body:g})};var Jb={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},Ib={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},pb={JSON:1313821514,BIN:5130562},ia=function(a,b,c){this.graph=void 0===a?null:a;this.source=void 0===b?-1:b;this.target=void 0===c?-1:c;this.found=!1;this._route=new Map;this._visited=new Set;this._spanningTree=new Set};ia.prototype.search=function(){var a=[],b=[],c=new U(this.source,this.source);for(a.push(c);0<
a.length;){var e=a.pop();this._route.set(e.to,e.from);this._visited.add(e.to);e!==c&&this._spanningTree.add(e);if(e.to===this.target)return this.found=!0,this;this.graph.getEdgesOfNode(e.to,b);e=$jscomp.makeIterator(b);for(var f=e.next();!f.done;f=e.next())f=f.value,!1===this._visited.has(f.to)&&a.push(f)}this.found=!1;return this};ia.prototype.getPath=function(){var a=[];if(!1===this.found||-1===this.target)return a;var b=this.target;for(a.push(b);b!==this.source;)b=this._route.get(b),a.unshift(b);
return a};ia.prototype.getSearchTree=function(){return[].concat($jscomp.arrayFromIterable(this._spanningTree))};ia.prototype.clear=function(){this.found=!1;this._route.clear();this._visited.clear();this._spanningTree.clear()};var ja=function(a,b,c){this.graph=void 0===a?null:a;this.source=void 0===b?-1:b;this.target=void 0===c?-1:c;this.found=!1;this._route=new Map;this._visited=new Set;this._spanningTree=new Set};ja.prototype.search=function(){var a=[],b=[],c=new U(this.source,this.source);a.push(c);
for(this._visited.add(this.source);0<a.length;){var e=a.shift();this._route.set(e.to,e.from);e!==c&&this._spanningTree.add(e);if(e.to===this.target)return this.found=!0,this;this.graph.getEdgesOfNode(e.to,b);e=$jscomp.makeIterator(b);for(var f=e.next();!f.done;f=e.next())f=f.value,!1===this._visited.has(f.to)&&(a.push(f),this._visited.add(f.to))}this.found=!1;return this};ja.prototype.getPath=function(){var a=[];if(!1===this.found||-1===this.target)return a;var b=this.target;for(a.push(b);b!==this.source;)b=
this._route.get(b),a.unshift(b);return a};ja.prototype.getSearchTree=function(){return[].concat($jscomp.arrayFromIterable(this._spanningTree))};ja.prototype.clear=function(){this.found=!1;this._route.clear();this._visited.clear();this._spanningTree.clear()};var ka=function(a,b,c){this.graph=void 0===a?null:a;this.source=void 0===b?-1:b;this.target=void 0===c?-1:c;this.found=!1;this._cost=new Map;this._shortestPathTree=new Map;this._searchFrontier=new Map};ka.prototype.search=function(){var a=[],b=
new O(G);for(b.push({cost:0,index:this.source});0<b.length;){var c=b.pop().index;if(!this._shortestPathTree.has(c)){!0===this._searchFrontier.has(c)&&this._shortestPathTree.set(c,this._searchFrontier.get(c));if(c===this.target)return this.found=!0,this;this.graph.getEdgesOfNode(c,a);for(var e=$jscomp.makeIterator(a),f=e.next();!f.done;f=e.next()){f=f.value;var g=(this._cost.get(c)||0)+f.cost;if(!1===this._searchFrontier.has(f.to)||g<this._cost.get(f.to))this._cost.set(f.to,g),this._searchFrontier.set(f.to,
